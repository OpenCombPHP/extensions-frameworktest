...
class BreakCompilerCase extends ControlPanel
{
	...
	{	
		...
		$arrB=array(0=>'第一次循环',1=>'第二次循环',2=>'第三次循环',3=>'第四次循环');
		$arrC=array(0=>'第一次循环',1=>'第二次循环',2=>'第三次循环',3=>'第四次循环');
		$arrD=array(0=>'第一次循环',1=>'第二次循环',2=>'第三次循环',3=>'第四次循环');
		$sText="Break功能测试：";
		$this->viewBreakCase->variables()->set('arrA',$arrA);
		$this->viewBreakCase->variables()->set('arrB',$arrB);
		$this->viewBreakCase->variables()->set('arrC',$arrC);
		$this->viewBreakCase->variables()->set('arrD',$arrD);
